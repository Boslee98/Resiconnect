...
if (strchr("$userid","AD")==true)
	...
	$username1=$_SESSION['adname'];
		include_once"setting/adminaddhelp_navigation.php";
	}
	else
	{
		
		$alusername=$_SESSION['alname'];
		include_once"setting/alumniaddhelp_navigation.php";
	...
	else
	{
		...
		if($result->num_rows > 0) 
		{
			while($row = $result->fetch_assoc())
			{
				...
				{			
					$sql = "INSERT INTO helpdata (help_author, help_title, help_content, help_time) 
					VALUES('$fauthor', '$ftitle', '$fmessage', '$ftime' )";
					if ($conn->query($sql) === TRUE) 
					{
	    				echo "<br /><p class=p1>*****Help successfully created.*****</p>";
						echo "<br /><p class=p2><a href=help_list.php>Go to help</a></p>";
					} 
					else 
					{
...
<h2>New Help Post</h2>
<br />
<form action="add_help_post.php" method="post">
...
<tr>
<td colspan=2 align="right"><button class="addforumbt" type="submit" name="addHelpPost" >Add Help Post</button></td>
</tr>
</table>
</form>
<br /><br /><br /><br />
