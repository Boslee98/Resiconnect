...
<html>
<head>
<title>Resiconnect - Approve </title>
...
if(isset($_POST['approve']))
{
	...
	if ($alid=='')
	{
		echo "<br /><p class=p1>*****Please insert Resiconnect Membership Number for membership approval.*****</p>";
	}
	else
	{
				...
				if ($conn->query($sql) === TRUE) 
				{
					...
					echo "<p class=p2><a href=manage_alumni.php>Resiconnect Membership</a></p><br>";
				} 
				else 
				{
...
<caption style= "font-size:30px"> Search Resiconnect Membership Number </caption>
<tr>
<th align="left" width="250" style="border:hidden;font-size:20px">Resiconnect Membership Number: </th>
...
<tr>
	<th> NO </th>
	<th> Resiconnect Membership Number </th>
	<th> Member Name</th>
