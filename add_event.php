...
<tr>
<th align="left" id="myTextArea" width="6000" style="border:hidden;font-size:25px"> Details of the event:</th>
<td></td>
</tr>
<tr>
...
<td width="350" id="myDateInput" style="border:hidden"><input class="i2" type="date" value="" name="eventdate" size="59"min="2020-06-06"required /></td>
<tr>
<tr>
...
<tr>
<td colspan=2 id="myform" align="center" style="border:hidden"><button class="bt1" type="submit" name="addEvent" >Add Event</button></td>
</tr>
</table>
</form>
